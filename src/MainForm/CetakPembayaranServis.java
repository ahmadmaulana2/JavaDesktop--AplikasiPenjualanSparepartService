 ...
 */
public class CetakPembayaranServis extends javax.swing.JFrame {

    /**
     * Creates new form CetakPembayaran
     */
    public CetakPembayaranServis() {
        initComponents();
    ...
    private void cetakbarang() {
        ...
        try {
            ...
            String sql = "SELECT no_faktur FROM tb_service WHERE hargasparepartklr !=''";
            ResultSet r = s.executeQuery(sql);

            while (r.next()) {
                cetakbtn.addItem(r.getString("no_faktur"));
            }
    ...
    private void initComponents() {
        ...
        kdkendaraan = new javax.swing.JTextField();
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                    ...
                    .addComponent(nmkendaraan, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGap(317, 317, 317)))
            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                    .addContainerGap(347, Short.MAX_VALUE)
                    .addComponent(kdkendaraan, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGap(307, 307, 307)))
            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                    .addContainerGap(347, Short.MAX_VALUE)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel2Layout.createSequentialGroup()
                    ...
                    .addGap(30, 30, 30)
                    .addComponent(nmpelanggan, javax.swing.GroupLayout.PREFERRED_SIZE, 0, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGap(30, 30, 30)
            ...
            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel2Layout.createSequentialGroup()
                    .addGap(220, 220, 220)
                    .addComponent(nmkendaraan, javax.swing.GroupLayout.PREFERRED_SIZE, 0, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addContainerGap(260, Short.MAX_VALUE)))
            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel2Layout.createSequentialGroup()
                    .addGap(230, 230, 230)
                    .addComponent(kdkendaraan, javax.swing.GroupLayout.PREFERRED_SIZE, 0, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addContainerGap(250, Short.MAX_VALUE)))
            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel2Layout.createSequentialGroup()
                    .addGap(230, 230, 230)
                    .addComponent(jenis, javax.swing.GroupLayout.PREFERRED_SIZE, 0, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addContainerGap(250, Short.MAX_VALUE)))
        );
    ...
    private void cetakbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cetakbtnActionPerformed
        if (cetakbtn.getSelectedItem().equals("- Nama Sparepart -")){
            ...
            try {
                ...
                String sql = "SELECT no_faktur,nm_pelanggan,kd_kendaraan,nm_kendaraan, nm_sparepartklr,hargasparepartklr,jenis_service,harga, bayar , kembalian ,tgl FROM tb_service WHERE no_faktur ='" + cetakbtn.getSelectedItem() + "'";
                ResultSet r = s.executeQuery(sql);
                ...
                while (r.next()) {
                    ...
                    nmpelanggan.setText(r.getString("nm_pelanggan"));
                    nmpelanggan.setForeground(Color.BLACK);
                    nmkendaraan.setText(r.getString("nm_kendaraan"));
                    nmkendaraan.setForeground(Color.BLACK);
                    kdkendaraan.setText(r.getString("kd_kendaraan"));
                    kdkendaraan.setForeground(Color.BLACK);
                    jenis.setText(r.getString("jenis_service"));
                    jenis.setForeground(Color.BLACK);
                    ...
                    nota.setText(nota.getText()+"No Polisi         : "+ kdkendaraan.getText()+"\n\n");
                    nota.setText(nota.getText()+"Nama Pelanggan    : "+ nmpelanggan.getText()+"\n\n");
                    nota.setText(nota.getText()+"Nama Sparepart    : "+ namabarangtxt.getText()+"\n\n");
                    nota.setText(nota.getText()+"Harga Sparepart   : "+ hargatxt.getText()+"\n\n");
                    nota.setText(nota.getText()+"Jenis Servis      : "+ jenis.getText()+"\n\n");
                    nota.setText(nota.getText()+"Jumlah Pesanan    : "+ nmpelanggan.getText()+"\n\n");
                    nota.setText(nota.getText()+"==================================\n");
    ...
    private void tambahMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tambahMouseClicked
        ...
        try {
            ...
            Logger.getLogger(CetakPembayaranServis.class.getName()).log(Level.SEVERE, null, ex);
        }       
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CetakPembayaranServis.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTextField kdkendaraan;
